...
const characters = [
  {
    name: "Troll",
    description: "Urban Legend. The one and only.",
    fullDescription:
      "The one and only. The legend. The myth. The troll. The one who skates like a god.",
    skill: "Speed boost and agility.",
    image: blaze,
    emoji: "🔥",
    animation: "blaze",
  ...
  {
    name: "Gork",
    description: "Urban Shadow. The one who skates in the shadows.",
    fullDescription:
      "The one who skates in the shadows. The one who skates like a ghost.",
    skill: "Stealth and speed.",
    image: shadow,
    emoji: "🌌",
    animation: "shadow",
  ...
  {
    name: "Alon",
    description: "Urban Nova. The one who skates like a star.",
    fullDescription:
      "The one who skates like a star. The one who skates like a comet.",
    skill: "Meteor shower and speed.",
    image: nova,
    emoji: "🌟",
    animation: "nova",
    bgGradient:
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 40; i++) {
      ...
      element.style.background = `radial-gradient(circle, ${
        ["rgba(255,65,108,0.3)", "rgba(0,201,255,0.3)", "rgba(252,176,69,0.3)"][
      ...
      >
        <h1
          style={{
            ...
            padding: "0",
            background:
              "linear-gradient(to right, #FF416C, #FF9900, #00C9FF, #fcb045)",
            backgroundClip: "text",
        ...
        <div
          style={{
            ...
            height: "3px",
            background:
              "linear-gradient(to right, transparent, #FF416C, #00C9FF, transparent)",
            margin: "1.5rem 0",
            ...
            <div
              style={{
                ...
                boxShadow: character.isLocked
                  ? "none"
                  : `0 0 10px ${character.cornerColor}`,
                border: `1px solid ${
                  character.isLocked ? "#555" : character.cornerColor + "99"
                }`,
                fontFamily: "'JetBrains Mono', monospace",
              }}
            >
            ...
            >
              <img
                ...
                style={{
                  ...
                  filter: character.isLocked
                    ? "grayscale(80%) brightness(0.7)"
                    : `drop-shadow(0 0 10px ${character.glowColor})`,
                }}
              />
              ...
              style={{
                ...
                background: character.isLocked
                  ...
                  : `linear-gradient(to right, ${
                      character.cornerColor
                    }, ${character.glowColor.replace("0.7", "1")})`,
                border: "none",
                borderRadius: "10px",
                color: "white",
                fontWeight: 700,
