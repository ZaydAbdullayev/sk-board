...
const Title = styled.h1`
  ...
  @keyframes neonPulse {
    from {
      text-shadow: 0 0 15px rgba(247, 37, 133, 0.7),
        0 0 25px rgba(76, 201, 240, 0.7), 0 0 35px rgba(255, 255, 255, 0.5);
    }
    to {
      text-shadow: 0 0 25px rgba(247, 37, 133, 0.9),
        0 0 35px rgba(76, 201, 240, 0.9), 0 0 45px rgba(255, 255, 255, 0.7);
    }
  }
...
const LevelCard = styled.div`
  ...
  ${(props) =>
    ...
    &:active {
      ...
      box-shadow: inset 0 0 20px rgba(255, 255, 255, 0.4), 0 12px 30px ${
        props.glowColor || "rgba(0, 0, 0, 0.4)"
      };
...
const Start = () => {
  ...
  return (
    <StartContainer>
      ...
      <Title>Trenches Skate</Title>
      <Subtitle>
        Welcome to the Trenches Skate!
        <br />
        Get ready to ride the waves of adventure and unlock new levels!
        <br />
        <span style={{ fontSize: "1.2rem", color: "#E6E6FA" }}>
          <strong>Click on the cards to start your journey!</strong>
        </span>
        <span style={{ fontSize: "1.2rem", color: "#E6E6FA" }}>
          <strong>Don't forget to explore all levels!</strong>
        </span>
      </Subtitle>
